...
class ArLocal {
    constructor(port = 1984, showLogs = true, dbPath, persist = false) {
        this.port = 1984;
        ...
        this.connection = connect_1.connect(dbPath);
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.app.use(koa_json_1.default());
    ...
    startDB() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (!this.persist)
                    fs_1.rmSync(this.dbPath, { recursive: true });
            }
            catch (e) { }
            if (!fs_1.existsSync(this.dbPath))
                fs_1.mkdirSync(this.dbPath, { recursive: true });
            // sqlite
            this.apollo = server_1.graphServer({
                introspection: true,
                playground: true,
            }, this.connection);
            this.apollo.applyMiddleware({ app: this.app, path: '/graphql' });
            if (!fs_1.existsSync(path_1.join(this.dbPath, 'db.sqlite')))
                yield initialize_1.up(this.connection);
        });
    }
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            initialize_1.down(this.connection, this.persist)
                .then(() => {
                this.apollo
                    .stop()
                    .then(() => {
