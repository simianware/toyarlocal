...
exports.resolvers = {
    Query: {
        transaction: (_, queryParams, { connection }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield query_1.generateQuery(params, connection);
            return result[0];
        }),
        transactions: (_, queryParams, { connection }) => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            const { timestamp, offset } = exports.parseCursor(queryParams.after || exports.newCursor());
            ...
            const results = (yield query_1.generateQuery(params, connection));
            ...
            return {
                ...
                edges: () => __awaiter(void 0, void 0, void 0, function* () {
                    return results.slice(0, pageSize).map((result, index) => {
                        return {
                            cursor: exports.encodeCursor({ timestamp, offset: offset + index + 1 }),
                            node: result,
                        };
                    });
                }),
        ...
        block: (_, queryParams, { connection }) => __awaiter(void 0, void 0, void 0, function* () {
            if (queryParams.id) {
                return (yield query_1.generateBlockQuery({
        ...
        blocks: (_, queryParams, { connection }) => __awaiter(void 0, void 0, void 0, function* () {
            const { timestamp, offset } = exports.parseCursor(queryParams.after || exports.newCursor());
            const pageSize = Math.min(queryParams.first || DEFAULT_PAGE_SIZE, MAX_PAGE_SIZE);
            let ids = [];
            let minHeight = 0;
            ...
            const query = query_1.generateBlockQuery({
                ids,
                select: blockFieldMap,
                minHeight,
                maxHeight,
    ...
    Transaction: {
        ...
        quantity: (parent) => {
            return {
                ar: ar_1.winstonToAr(parent.quantity || 0),
                winston: parent.quantity || 0,
            };
        },
        fee: (parent) => {
            return {
                ar: ar_1.winstonToAr(parent.fee || 0),
    ...
    Block: {
        ...
        */
        timestamp: (parent) => {
            return moment_1.default(parent === null || parent === void 0 ? void 0 : parent.timestamp).unix();
        },
    },
};
const newCursor = () => exports.encodeCursor({ timestamp: moment_1.default().toISOString(), offset: 0 });
